...
describe('Reserva Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Reserva', () => {
      ...
      service.create(reserva).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Reserva', () => {
      ...
      service.update(reserva).subscribe(resp => (expectedResult = resp));
    ...
    describe('addReservaToCollectionIfMissing', () => {
      it('should add a Reserva to an empty array', () => {
        ...
        expect(expectedResult).toEqual([reserva]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([reserva, reserva2]);
      });

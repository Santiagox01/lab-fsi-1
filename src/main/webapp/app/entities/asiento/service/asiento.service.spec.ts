...
describe('Asiento Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Asiento', () => {
      ...
      service.create(asiento).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Asiento', () => {
      ...
      service.update(asiento).subscribe(resp => (expectedResult = resp));
    ...
    describe('addAsientoToCollectionIfMissing', () => {
      it('should add a Asiento to an empty array', () => {
        ...
        expect(expectedResult).toEqual([asiento]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([asiento, asiento2]);
      });
